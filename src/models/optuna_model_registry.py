...
from .random_forest import get_random_forest_config
from .hist_gradient_boosting import get_hist_gradient_boosting_config
from .stacking_classifier import get_stacking_config
from .voting_classifier import get_voting_config
from .bagging_classifier import get_bagging_config
...
class OptunaModelRegistry:
    ...
    def get_random_forest_config() -> ModelConfig:
        return get_random_forest_config()
    
    @staticmethod
    def get_hist_gradient_boosting_config() -> ModelConfig:
        return get_hist_gradient_boosting_config()
    
    @staticmethod
    def get_stacking_config() -> ModelConfig:
        return get_stacking_config()
...
#         # Base estimator is fixed with optimal configuration
#         base_estimators = [
#             ('hgb', HistGradientBoostingClassifier(
#                 class_weight={0: 1, 1: 1},
#                 early_stopping=True,
...
#         # Create initial bagging classifier
